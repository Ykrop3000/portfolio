    ...
    <>
      ...
      <Layout>
        ...
        <Section delay={0.2}>
          ...
          <Text>
            Доброго времени суток, меня зовут Андреев Григорий. Я занимаюсь
            web-разработкой с нуля, под ключ. Выполняю верстку и
            программирование сайтов, а так же доработку, добавляя полный
            функционал на сайт! Верстаю адаптивную верстку с помощью React,
            таким образом сайт получается красивым на любом устройстве, будь то
            комьютер, ноутбук или телефон! Готов предложить широкий диапазон
            работ в любой сфере услуг. Так же гарантирую быстрое и качественное
            выполнение заказов. Индивидуальный подход к каждому клиенту.
            Множество приятных бонусов и скидок.
          </Text>
        </Section>
